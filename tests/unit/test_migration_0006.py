...
def test_0009_migration_defines_provider_settings_table() -> None:
    migration = Path("alembic/versions/0009_provider_settings.py")
...
def test_0009_migration_upgrades_and_downgrades_sqlite(tmp_path: Path) -> None:
    ...
    with sqlite3.connect(db_path) as conn:
        ...
        assert "app_settings" in tables_after
